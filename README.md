...
## Two COBOL programming tasks here
...
## Add GnuCOBOL to your mac.

to get it

`brew install gnu-cobol`

also, in vscode, add the IBM Z Open Editor extension.
...
cobc -h
```
gives you the command line options...
